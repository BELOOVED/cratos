...
<div class="heading" style="margin-top:100px;">İŞLEM GEÇMİŞİ</div>
<div id="content" class="bgMain account_content ">

    <div class="filter-block transactionhistory-div ">
        <form action="/Account/TransactionsHistory" id="searchForm" method="post" novalidate="novalidate"
              data-gtm-form-interact-id="0">
            <div class="search_popup_row">
                <label for="period">Finansal İşlemler</label>
                <div class="ui-select">
                    <div id="transactiontype-button"
                         class="ui-btn ui-icon-carat-d ui-btn-icon-right ui-corner-all ui-shadow">
                        <select class="drop-down valid" id="transactiontype" name="TransactionTypeId">
...
<div id="footer" class="bgMain">
    <div class="footer_cont ">
        ...
        <div class="social_icons_footer frow flex jc">
            ...
            <a class="yandex_mail ui-link" href="/cdn-cgi/l/email-protection#72161701061719321500131c160213011a131017065c111d1f" target="_blank" rel="noopener"></a>
