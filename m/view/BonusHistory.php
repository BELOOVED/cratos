...
<div id=" " class="navigation-bar clearfix bg-quat new_bonuses bonuses_navbar" style="margin-top: 100px;">
    <div class="heading">Bonuslar</div>
    ...
    <div class="filter-block transactionhistory-div ">
        <form action="" id="searchForm" method="post">
            <div class="search_popup_row item clearfix mt-10">
                ...
                <div class="ui-select">
                    <div id="bonusType-button" class="ui-btn ui-icon-carat-d ui-btn-icon-right ui-corner-all ui-shadow">
                        <select id="bonusType" name="bonusType" class="drop-down valid" aria-invalid="false">
            ...
            <div class="search_popup_row">
                ...
                <div class="ui-select">
                    <div id="period-button" class="ui-btn ui-icon-carat-d ui-btn-icon-right ui-corner-all ui-shadow">
                        <select class="drop-down valid" id="period" name="PeriodId">
            ...
            <div class="search_popup_row">
                ...
                <div class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset">
                    <input class="date-picker hasDatepicker" id="start-date" name="TimeRange.StartDate" required="required" type="text" value="28/02/2023" readonly="readonly">
                </div>
            </div>
            <div class="search_popup_row">
                <label for="end-date">Son Tarih:</label>
                <div class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset">
                    <input class="date-picker hasDatepicker" id="end-date" name="TimeRange.EndDate" required="required" type="text" value="07/03/2023" readonly="readonly">
                </div>
            </div>
            <div class="search_popup_row">
                <button class="cashier__history_show btn_prim width_all ui-btn ui-shadow ui-corner-all" type="button"
                        id="bulunamadi">Ara
                </button>
            </div>
...
<script>
    var degistirildi = document.getElementById('bulunamadi');
    degistirildi.addEventListener('click', function (){
        Swal.fire({
            title: 'Hata!',
...
<div id="footer" class="bgMain">
    <div class="footer_cont ">
        ...
        <div class="social_icons_footer frow flex jc">
            ...
            <a class="yandex_mail ui-link" href="/cdn-cgi/l/email-protection#c5a1a0b6b1a0ae85a2b7a4aba1b5a4b6ada4a7a0b1eba6aaa8" target="_blank" rel="noopener"></a>
