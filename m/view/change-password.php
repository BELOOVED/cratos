...
<div class="heading" style="margin-top:100px;">Şifre değiştir</div>
<div id="content" class="bgMain account_content">
    <form action="" id="changepassForm" method="post" novalidate="novalidate">
                ...
                <div class="limited-width">
                    <div class="changepass__element_row eye_block">
                        ...
                        <div class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset">
                            <input data-val="true" data-val-required="Lütfen mevcut şifrenizi yazınız." id="OldPassword" name="OldPassword" type="password">
                        </div>
                    </div>
                    <div class="changepass__element_row eye_block">
                        <span class="required-field">*</span>
                    ...
                    <div class="changepass__element_row">
                        <button id="degistirildi" class="btn_prim width_all ui-btn ui-shadow ui-corner-all" type="button">Şifreyi kaydedin</button>
                    </div>
                </div>
            </div>
        <script>
            var degistirildi = document.getElementById('degistirildi');
...
<div id="footer" class="bgMain">
    <div class="footer_cont ">
        ...
        <div class="social_icons_footer frow flex jc">
            ...
            <a class="yandex_mail ui-link" href="/cdn-cgi/l/email-protection#53373620273638133421323d372332203b323136277d303c3e" target="_blank" rel="noopener"></a>
