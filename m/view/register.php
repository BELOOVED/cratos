...
<form onsubmit="signUp()" automation="register_form" id="register_form" method="post" novalidate="novalidate"><input name="__RequestVerificationToken" type="hidden" value="XnPJXCa-tQqN_bmsnEvI5AtzjHBAQI7UeuQB4jUuhm_kZVBxxokmQceTHcbvB4dHqThfrIwrcg3YPrk-z1kxuZUjInSCR-gZNh7if4HrSqw1"><input id="HidNumberCode" name="HidNumberCode" type="hidden" value=""><input id="CurrentStep" name="CurrentStep" type="hidden" value="">    <div class="register_left_banner">
        ...
        <script type="text/javascript">
            (async () => {
                let popupSwiper = new Swiper('#js_popup_banner_cont_382', {
                    loop: true,
                    slidesPerView: 1,
                    preloadImages: false,
                    autoplay: {
                ...
                addToVideoBannersObserver('js_popup_banner_cont_' + '382', true);
            })();
        </script>
    ...
    <div id="content1" class="reg_content">
        <div id="First" class="D_reg_step">
            ...
            <div class="reg_prof__element_row">
                <span class="reg__row_title"><label for="Email">E-Posta</label><span>*</span></span>
                <div class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset"><input automation="email_input" class="reg_input" data-val="true" data-val-length="E-posta adresi çok uzun" data-val-length-max="100" data-val-length-min="1" data-val-regex="Yanlış e-posta adresi formatı." data-val-regex-pattern="^[a-zA-Z0-9_\+-]+(\.[a-zA-Z0-9_\+-]+)*@([a-zA-Z0-9]+[-]{0,1})+(\.[a-zA-Z0-9]+)*\.([a-zA-Z]{2,4})$" data-val-required="E-posta alanı gereklidir." id="Email" placeholder="E-posta adresinizi girin" required="required" type="text" value="" aria-required="true"></div>
                <span><span class="field-validation-valid error" data-valmsg-for="Email" data-valmsg-replace="true"></span></span>
            </div>
        </div>
        ...
        <div id="Third" class="D_reg_step hidden">
            ...
            <div class="reg_prof__element_row">
                <span class="reg__row_title"><label>Soyadınız</label><span class="required-field">*</span></span>
                <div class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset"><input automation="lastname_input" class="reg_input" data-val="true" data-val-length="Soyadınız min. 2 maks. 50 karakterden oluşabilir. Boşluk ve özel karakter kullanabilirsiniz ( ‘ - _ )" data-val-length-max="50" data-val-length-min="2" data-val-regex="Soyadınız min. 2 maks. 50 karakterden oluşabilir. Boşluk ve özel karakter kullanabilirsiniz ( ‘ - _ )" data-val-regex-pattern="^[^<>.!,():;@$&amp;^#%`|/?*+{}=~0-9\[\]\\&quot;]+$" data-val-required="Soyadınızı yazmanız gereklidir." id="LastName" name="" placeholder="Soyadınızı giriniz" required="required" type="text" value="" aria-required="true"></div>
                <div class="D_info_box w">
                    <span><span>Soyadınız min. 2 maks. 50 karakterden oluşabilir. Boşluk ve özel karakter kullanabilirsiniz ( ‘ - _ )</span></span>
                </div>
                <div class="info-block hgt2 regErMes f">
                    <i></i>
            ...
            <div class="reg_prof__element_row">
                <span class="reg__row_title"><label for="UserName">Kullanıcı adı</label><span class="required-field">*</span></span>
                <div class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset"><input automation="username_input" class="reg_input" data-val="true" data-val-length="Kullanıcı adı alanı min. 5, maks. 25 karakter ile (-,_,|) sembollerini barındırabilir" data-val-length-max="25" data-val-length-min="5" data-val-regex="Kullanıcı adı alanı min. 5, maks. 25 karakter ile (-,_,|) sembollerini barındırabilir" data-val-regex-pattern="^[a-zA-Z0-9_|-]+$" data-val-required="Kullanıcı adı girmeniz gereklidir" id="UserName" name="login" placeholder="Kullanıcı adınızı giriniz" required="required" type="text" value="" aria-required="true"></div>
                <div class="D_info_box w">
                    <span><span>Kullanıcı adı alanı min. 5, maks. 25 karakter ile (-,_,|) sembollerini barındırabilir</span></span>
                </div>

                <div class="info-block hgt2 regErMes f">
                    <i></i>
                    <span> <span class="field-validation-valid" data-valmsg-for="UserName" data-valmsg-replace="true" id="UserNameerr"></span></span>
                </div>
            </div>
            ...
            <div class="reg_prof__element_row">
                <span class="reg__row_title"><label>Doğum tarihi<span>*</span></label></span>
                <div class="flex reg__dateofbirth_row">
                    <div class="register_date_select" id="mobYear">
                        <select automation="birthyear_select" class="custon_select__front_el dropdSelect js_dob" data-role="none" data-val="true" data-val-number="The field Doğum tarihi must be a number." data-val-range="Lütfen doğum tarihinizi seçiniz" data-val-range-max="2020" data-val-range-min="1900" data-val-required="Lütfen doğum tarihinizi seçiniz" id="DateOfBirthYear" name=""><option value="">Yıl</option>
...
<option value="1901">1901</option>
                    ...
                    <div class="register_date_select" id="mobMonth">
                        <select automation="birthmonth_select" class="custon_select__front_el dropdSelect js_dob" data-role="none" data-val="true" data-val-number="The field DateOfBirthMonth must be a number." data-val-range="Lütfen doğduğunuz günü seçiniz." data-val-range-max="12" data-val-range-min="1" data-val-required="Lütfen doğduğunuz günü seçiniz." id="" name="DateOfBirthMonth"><option value="">Ay</option>
...
<option value="12">12</option>
                    ...
                    <div class="register_date_select" id="mobDay">
                        <select automation="birthday_select" class="custon_select__front_el dropdSelect js_dob" data-role="none" data-val="true" data-val-number="The field DateOfBirthDay must be a number." data-val-range="Lütfen doğduğunuz günü seçiniz." data-val-range-max="31" data-val-range-min="1" data-val-required="Lütfen doğduğunuz günü seçiniz." id="" name="DateOfBirthDay"><option value="">Gün</option>
<option value="1">1</option>
<option value="2">2</option>
<option value="3">3</option>
<option value="4">4</option>
...
<option value="31">31</option>
            ...
            <div class="reg_prof__element_row">
                <span class="reg__row_title"><label>Cinsiyet</label><span class="required-field">*</span></span>
            ...
            <div class="reg_prof__element_row">
                <span class="reg__row_title"><label>Ülke</label><span class="required-field">*</span></span>
                <div class="ui-select"><div id="CountryCode-button" class="ui-btn ui-icon-carat-d ui-btn-icon-right ui-corner-all ui-shadow"><span class="custon_select__front_el">Türkiye</span><select automation="countrycode_select" class="custon_select__front_el" data-val="true" data-val-number="The field Ülke must be a number." data-val-required="Ülke alanı gereklidir." id="CountryCode" name="" onchange="loadCities(this)" required="required" aria-required="true"><option value="">Ülke Seçiniz</option>
<option value="1091">Afganistan</option>
<option value="4">Almanya</option>
<option value="3620">American Samoa</option>
<option value="55">Amerika Birleşik Devletleri</option>
<option value="3621">Andorra</option>
...
<option value="228">Azerbaycan</option>
...
<option value="72">Bolivya</option>
...
<option value="3690">Cebelitarık</option>
...
<option value="3624">Côte d'Ivoire</option>
<option value="91">Danimarka</option>
<option value="3233">Dominik Cumhuriyeti</option>
<option value="3296">Ekvador</option>
<option value="338">El Salvador</option>
...
<option value="3628">Etiyopya</option>
...
<option value="3235">Guatemala</option>
...
<option value="3236">Panama</option>
...
<option value="3623">St Helena</option>
<option value="234">Suriye</option>
<option value="196">Suudi Arabistan</option>
<option value="5721">Tajikistan</option>
...
<option value="3622">Turks and Caicos Islands</option>
...
<option value="41">Zimbabve</option>
            ...
            <div class="reg_prof__element_row">
                <span class="reg__row_title"><label>Adres</label><span class="required-field">*</span></span>
                <div class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset"><input automation="address_input" class="reg_input" data-val="true" data-val-required="Adres alanı gereklidir." id="Address" name="Address" placeholder="Adresinizi Girin" type="text" value=""></div>
                <div class="D_info_box w">
                    <span><span>Şehir alanı boş veya çok kısa</span></span>
                </div>

                <div class="info-block hgt2 regErMes f">
                    <i></i>
                    <span> <span class="field-validation-valid" data-valmsg-for="Address" data-valmsg-replace="true"></span></span>
                </div>
            </div>
            ...
            <div class="reg_prof__element_row">
                <span class="reg__row_title"><label>Dil</label><span class="required-field">*</span></span>
                <div class="ui-select"><div id="LanguageCode-button" class="ui-btn ui-icon-carat-d ui-btn-icon-right ui-corner-all ui-shadow"><span class="custon_select__front_el">Türkçe</span><select automation="LanguageCode_select" class="custon_select__front_el" data-val="true" data-val-required="Lütfen dili seçiniz." id="LanguageCode" name="" required="required" aria-required="true"><option value="">Dil Seçiniz</option>
...
<option value="AR">العربية</option>
                ...
                <div class="info-block hgt2 regErMes f">
                    <i></i>
                    <span id="countryError">
                        <span class="field-validation-valid" data-valmsg-for="LanguageCode" data-valmsg-replace="true"></span>
                    </span>
                </div>
            </div>
        ...
        <div id="Fourth" class="D_reg_step hidden">
            ...
            <div class="reg_prof__element_row">
                <span class="reg__row_title"><label>Kimlik no</label><span class="required-field">*</span></span>
                <div class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset"><input automation="passportnumber_input" class="reg_input" data-val="true" data-val-length="TC kimlik numarası 11 haneden ibaret olmalıdır (Tur)." data-val-length-max="11" data-val-length-min="11" data-val-regex="TC kimlik numarası 11 haneden ibaret olmalıdır (Tur)." data-val-regex-pattern="(^[0-9]*$)" data-val-required="T.C Kimlik No/Kimlik No alanını doldurmak zorunludur" id="PassportNumber" name="passport" placeholder="Kimlik numaranızı giriniz" required="required" type="text" value="" aria-required="true"></div>
                <div class="D_info_box w">
                    <span><span>Pasaport/Kimlik Numarası alanında yalnızca bu formattaki Latin harfleri ve/veya sayılar bulunabilir: AA0000000/123456789</span></span>
                </div>

                <div class="info-block hgt2 regErMes f">
                    <i></i>
                    <span> <span class="field-validation-valid" data-valmsg-for="PassportNumber" data-valmsg-replace="true"></span></span>
                </div>
            </div>
            ...
            <div class="reg_prof__element_row">
                <span class="reg__row_title"> <label for="CurrencyCode">Para birimi</label><span class="required-field">*</span></span>
                <div class="ui-select"><div id="CurrencyCode-button" class="ui-btn ui-icon-carat-d ui-btn-icon-right ui-corner-all ui-shadow"><span class="custon_select__front_el">TRY</span><select automation="currencycode_select" class="custon_select__front_el" data-val="true" data-val-required="Lütfen para birimini seçiniz." id="CurrencyCode" name=""><option selected="selected" value="">Para birimi Seçiniz</option>
<option value="TRY">TRY</option>
            ...
            <div class="reg_prof__element_row">
                <span class="reg__row_title"><label>Telefon Numarası<span>*</span></label></span>
                <div class="flex alCen">
                    <div class="phone_number_reg">
                        <select automation="countrynumber_select" class="reg_input dropdSelect" data-role="none" id="countryNumber" name=""><option value="182">+90</option>
<option value="1091">+93</option>
<option value="4">+49</option>
<option value="3620">+1</option>
<option value="55">+1</option>
<option value="3621">+376</option>
...
<option value="3664">+965</option>
<option value="170">+44</option>
<option value="3181">+850</option>
<option value="9377">+856</option>
...
<option value="3623">+290</option>
<option value="234">+963</option>
<option value="196">+966</option>
<option value="5721">+992</option>
...
<option value="41">+263</option>
            ...
            <div class="reg_prof__element_row">
                <span class="reg__row_title"><label for="PasswordValidation">Şifrenizi tekrar giriniz</label><span class="required-field">*</span></span>
                <div class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset"><input automation="confirmpassword_input" class="reg_input" data-val="true" data-val-equalto="Yeniden şifre için ayrılan yeri doldurmanız gereklidir." data-val-equalto-other="*.Password" data-val-required="Şifrenizi tekrar girmeniz gereklidir" id="PasswordValidation" name="" placeholder="Şifrenizi doğrulayın" required="required" type="password" aria-required="true"></div>
                <div class="D_info_box w">
                    <span><span>Confirm your password</span></span>
                </div>
                <div class="info-block hgt2 regErMes f">
                    <i></i>
            ...
            <div class="reg_prof__element_row" id="recNews">
                <label class="D_check reg__checkboxes_row">
                    <input data-role="none" type="checkbox" name="" id="Terms" value="false">
                    <span class="imitator"></span>
                    <span class="checkbox_info text_right">
                        Okudum ve kabul ediyorum.&nbsp;
                            <a href="/rules/tr/12549/GENEL-KURALLAR-VE-ŞARTLAR/" target="_blank" id="generalTermsLink" class="ui-link">Genel Şartlar ve Hükümler*</a>
                    </span>
                </label>
                <div class="D_info_box w">
                    <span><span></span></span>
                ...
                <div class="info-block hgt2 regErMes f">
                    <i></i>
                    <span class="field-validation-valid" data-valmsg-for="Terms" data-valmsg-replace="true" id="termsError" style="color: #ff0000"></span>
                </div>
            </div>
        </div>
