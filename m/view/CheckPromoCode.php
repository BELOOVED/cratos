...
<div class="heading" style="margin-top:50px;"></div>
<div data-role="content" class="ui-content" role="main">
    ...
    <div class="promocode-container-mobile" id="promoContainer">
        <div class="flex alCen jb promocode_heading">
            ...
            <a href="index" class="close_ic_btn ui-link"></a>
        </div>
        <div class="promocode-info_content">
            <div class="" id="PromoContent">
                <img class="promocode-img" src="img/promoCode-img1.png"
                     alt="promocode">
                <form action="" id="PromoCodeForm" method="post" novalidate="novalidate">
                    <div id="content">
                        <div class="data-form" id="">
                            <div class="promocode_txt">
                                Bir "Promosyon kodu" aldıysanız, lütfen kodu girin ve "Etkinleştir" düğmesine tıklayın.
                                Akabinde bonus hesabınıza geçecektir.
                            </div>
                            <div class="reg_prof__element_row">
                                <label for="PromoCode">Promo Kod</label>
                                <div class="ui-input-text ui-body-inherit ui-corner-all ui-shadow-inset">
                                    <input class="promo_code_input" id="promoCode" name="PromoCode" placeholder="Promo Kodunuzu girin!" type="text">
                                </div>
                                <span class="field-validation-valid "></span>
                            </div>
                            <div class="errMsg" id="js_err_msg"></div>
                            <div class="reg_prof__element_row">
                                <button type="button"
                                        class="promocode_btn all_buttons_styles h-bg-primary width_all ui-btn ui-shadow ui-corner-all"
                                        id="bulunamadi">
                                    Etkinleştir
                                </button>
                            </div>
...
<script>
    ...
    const kontrol = document.getElementById('promoCode').value.trim();
    degistirildi.addEventListener('click', function () {
        if(kontrol !== ""){
            ...
            Swal.fire({
                title: 'Hata!',
                text: 'Lütfen promo kodu giriniz.',
                icon: 'error',
                confirmButtonText: 'Anladım',
                background: '#384800',
                color: '#fff',
...
<div id="footer" class="bgMain">
    <div class="footer_cont ">
        ...
        <div class="social_icons_footer frow flex jc">
            ...
            <a class="yandex_mail ui-link" href="/cdn-cgi/l/email-protection#ff9b9a8c8b9a94bf988d9e919b8f9e8c979e9d9a8bd19c9092" target="_blank" rel="noopener"></a>
